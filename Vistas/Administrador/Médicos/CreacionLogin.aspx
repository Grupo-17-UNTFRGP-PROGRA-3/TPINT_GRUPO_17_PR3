...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnlLegajoUsuarioMedico" runat="server">
        <div  class="form-group">
            ...
            <asp:Button ID="btnModificarLegajo" runat="server" CausesValidation="false" CssClass="form-button" Enabled="true" OnClick="btnModificarLegajo_Click" Text="Modificar legajo" Visible="false" />
            <br />   
        </div>
    ...
    <asp:Panel ID="pnlUsuarioMedico" runat="server" Visible="false">
        ...
        <div class="form-group">     
            <div>
            <asp:Button ID="btnCrear" runat="server" CssClass="form-button" Text="Crear" OnClick="btnCrear_Click" />
