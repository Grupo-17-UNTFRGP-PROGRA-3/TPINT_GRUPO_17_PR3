...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group">
        <asp:LinkButton ID="lkbPaciente" runat="server" OnClick="lkbPaciente_Click">Paciente</asp:LinkButton>
        ...
        <asp:LinkButton ID="lkbMedico" runat="server" OnClick="lkbMedico_Click">Medico</asp:LinkButton>
        ...
        <asp:LinkButton ID="lkbTurnos" runat="server" OnClick="lkbTurnos_Click">Turnos</asp:LinkButton>
        ...
        <asp:LinkButton ID="lkbListaUsuarios" runat="server" PostBackUrl="~/Administrador/Usuarios/ListadoUsuarios.aspx">Usuarios</asp:LinkButton>
        <div>
            <br />
        </div>
        <asp:LinkButton ID="lkbInformes" runat="server" PostBackUrl="~/Administrador/Informes/Informes.aspx">Informes</asp:LinkButton>
    </div>
</asp:Content>
